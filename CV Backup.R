...
colnames(crossValM11P) <- c("hhid","cndurWOR","cndurImputedM12P","percentAbsError") 
...
cat("\nCorrelation for Model1 1-Person Households ",cor(hrs$cndurWOR,hrs$cndurImputed))


plot(hrs$cndurWOR,hrs$cndurImputed,xlim=c(0,40000),ylim=c(0,40000),title(main=paste("Model 1 ",dim(hrs)[1],' 1-Person Households')),xlab="Reported Consumption",ylab="Imputed Consumption")
text(30000,10000,paste("correlation ",round(cor(hrs$cndurWOR,hrs$cndurImputed),3)))
fitTrend4 <- lm(hrs$cndurImputed ~ hrs$cndurWOR)
abline(fitTrend4, col="red", lwd=1) 
...
cat("\nCorrelation for Model1 2-Person Households ",cor(hrs$cndurWOR,hrs$cndurImputed))

plot(hrs$cndurWOR,hrs$cndurImputed,xlim=c(0,40000),ylim=c(0,40000),title(main=paste("Model 1 ",dim(hrs)[1],' 2-Person Households')),xlab="Reported Consumption",ylab="Imputed Consumption")
text(30000,10000,paste("correlation ",round(cor(hrs$cndurWOR,hrs$cndurImputed),3)))
fitTrend3 <- lm(hrs$cndurImputed ~ hrs$cndurWOR)
abline(fitTrend3, col="red", lwd=1) 
