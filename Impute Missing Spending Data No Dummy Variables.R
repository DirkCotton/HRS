...
# create columns =1 if retirement in that wave, else zero  
  ...
  cams1Pgtw$ageSquared1 <- cams1Pgtw$ageAtRetirement1^2
  ...
  fit <- lm(cams1Pgtw$cndurWOR ~ 
            ...
            + cams1Pgtw$ageSquared1)
  
  cat("\n\n")
  print(summary(fit))
  
  cams1Pgtw$cndurExpected <- (fit$coefficients[5] * cams1Pgtw$male + fit$coefficients[1] * cams1Pgtw$ssIncAtRetire1 + fit$coefficients[2] * cams1Pgtw$portfolioAssetsTotal + fit$coefficients[3] * cams1Pgtw$pensionIncome + fit$coefficients[4] * cams1Pgtw$ageAtRetirement1 + fit$coefficients[6] * cams1Pgtw$earliestRetire + fit$coefficients[7] * cams1Pgtw$EarliestSquared + fit$coefficients[8] * cams1Pgtw$ageSquared1)
  ...
  hrs$cndurImputed[hrs$earliestRetire >= 5 & hrs$persons == 1] <- 
    (  fit$coefficients[1]
     + fit$coefficients[2] * hrs$ssIncAtRetire1[hrs$earliestRetire >= 5 & hrs$persons == 1] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 1] 
     + fit$coefficients[3] * hrs$portfolioAssetsTotal[hrs$earliestRetire >= 5 & hrs$persons == 1] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 1] 
     + fit$coefficients[4] * hrs$pensionIncome[hrs$earliestRetire >= 5 & hrs$persons == 1] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 1] 
     + fit$coefficients[5] * hrs$ageAtRetirement1[hrs$earliestRetire >= 5 & hrs$persons == 1]
     + fit$coefficients[6] * hrs$male[hrs$earliestRetire >= 5 & hrs$persons == 1] + fit$coefficients[7] * hrs$earliestRetire[hrs$earliestRetire >= 5 & hrs$persons == 1]
     + fit$coefficients[7] * hrs$earliestRetire[hrs$earliestRetire >= 5 & hrs$persons == 1] 
     + fit$coefficients[8] * hrs$earliestRetire[hrs$earliestRetire >= 5 & hrs$persons == 1] ^2
     + fit$coefficients[9] * hrs$ageAtRetirement1[hrs$earliestRetire >= 5 & hrs$persons == 1] ^2
     ) 
...
#########################################  
  ...
  cams2Pgtw$ageSquared1 <- cams2Pgtw$ageAtRetirement1^2
  cams2Pgtw$ageSquared2 <- cams2Pgtw$ageAtRetirement2^2
  ...
  fit2 <- lm(  cams2Pgtw$cndurWOR ~ cams2Pgtw$ssIncAtRetire1
             ...
             + cams2Pgtw$ageSquared1
             + cams2Pgtw$ageSquared2
             ) 
  ...
  cams2Pgtw$cndurExpected <- (  fit2$coefficients[1]
                              + fit2$coefficients[2]  * cams2Pgtw$ssIncAtRetire1
                              + fit2$coefficients[3]  * cams2Pgtw$ssIncAtRetire2 
                              + fit2$coefficients[4]  * cams2Pgtw$portfolioAssetsTotal 
                              + fit2$coefficients[5]  * cams2Pgtw$pensionIncome 
                              + fit2$coefficients[6]  * cams2Pgtw$ageAtRetirement1 
                              + fit2$coefficients[7]  * cams2Pgtw$ageAtRetirement2 
                              + fit2$coefficients[8]  * cams2Pgtw$earliestRetire 
                              + fit2$coefficients[9]  * cams2Pgtw$EarliestSquared 
                              + fit2$coefficients[10] * cams2Pgtw$ageSquared1 
                              + fit2$coefficients[11] * cams2Pgtw$ageSquared2
                              )
  ...
  hrs$cndurImputed[hrs$earliestRetire >= 5 & hrs$persons == 2] <- (  fit2$coefficients[1]
                                                                   + fit2$coefficients[2]  * hrs$ssIncAtRetire2[hrs$earliestRetire >= 5 & hrs$persons == 2] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[3]  * hrs$portfolioAssetsTotal[hrs$earliestRetire >= 5 & hrs$persons == 2] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[4]  * hrs$pensionIncome[hrs$earliestRetire >= 5 & hrs$persons == 2] / hrs$gtw[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[5]  * hrs$ageAtRetirement1[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[6]  * hrs$ageAtRetirement2[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[7]  * hrs$earliestRetire[hrs$earliestRetire >= 5 & hrs$persons == 2] 
                                                                   + fit2$coefficients[8]  * hrs$earliestRetire[hrs$earliestRetire >= 5 & hrs$persons == 2]^2
                                                                   + fit2$coefficients[9]  * hrs$ageAtRetirement1[hrs$earliestRetire >= 5 & hrs$persons == 2]^2
                                                                   + fit2$coefficients[10] * hrs$ageAtRetirement2[hrs$earliestRetire >= 5 & hrs$persons == 2]^2
  ...
  fit3 <- lm(cams1Pgtw$cndurWOR ~ cams1Pgtw$male + cams1Pgtw$ssIncAtRetire1 + cams1Pgtw$portfolioAssetsTotal + cams1Pgtw$pensionIncome + cams1Pgtw$ageAtRetirement1 + cams1Pgtw$ageSquared1)
  
  cat("\n\nfit3: 1-person household, no dummy variables")
  print(summary(fit3))
  
  cams$noDummy1P <- rep(0,dim(cams)[1])
  cams$noDummy1P <- (fit3$coefficients[1] + fit3$coefficients[2] * cams$male + fit3$coefficients[3] * cams$ssIncAtRetire1 / cams$gtw + fit3$coefficients[4] * cams$portfolioAssetsTotal / cams$gtw + fit3$coefficients[5] * cams$pensionIncome / cams$gtw + fit3$coefficients[6] * cams$ageAtRetirement1 + fit3$coefficients[7] * cams$ageAtRetirement1)
  ...
  hrs$cndurImputed[hrs$earliestRetire <= 4 & hrs$persons == 1] <- 
    (  fit3$coefficients[1]
     ...
     + fit3$coefficients[7] * hrs$ageAtRetirement1[hrs$earliestRetire <= 4 & hrs$persons == 1]^2 
     ) 
  ...
  # save data for this second model to compare to first model
  write.csv(dummy1P,'~/desktop/nodummy1P.csv')
  write.csv(dummy2P,'~/desktop/nodummy2P.csv')