...
pBad <- plot(density(crossValOnePerson[,1]),main="1-Person Household Bad Predictions\nPredicted - Actual",ylim=c(0,.00008),xlim=c(-100000,50000),xlab="Prediction Error ($)")
for (i in 2:n){
