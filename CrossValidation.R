...
saveM11P <- cbind(hrs$hhid,hrs$cndurWOR,round(hrs$cndurImputedM2))
colnames(saveM11P) <- c("hhid","cndurWOR","cndurImputedM21P") 
...
# for cross-validation, store hrs imputed data for 1-person households
saveM12P <- cbind(hrs$hhid,hrs$cndurWOR,round(hrs$cndurImputedM2))
colnames(saveM12P) <- c("hhid","cndurWOR","cndurImputedM21P") 
